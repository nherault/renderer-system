...
import { PATH_DATA } from '../../renderer-data.types';
export function renderPath2DOptions(_a) {
    ...
    context.closePath();
    computeStrokeFill(strokeFillOptions, function () { return context.stroke(); }, function () { return context.fill(); });
}
export function renderPath2D(_a) {
    ...
    var _c = calculatePath2DContainerSize(currentRenderer.path), width = _c.width, height = _c.height;
...
export var calculatePath2DContainerSize = function (path) {
    var minX = 0;
    var minY = 0;
    var maxX = 0;
    var maxY = 0;
